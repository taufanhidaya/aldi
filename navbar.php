<?php
// Start the session at the beginning of the file session_start(); // Check if user is logged in
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNavDropdown">
            ...
            <div class="d-flex align-items-center">
                ...
                <!-- Dropdown Profil -->
                <div class="dropdown">
                    <!-- Display username above profile picture -->
                    <div class="d-flex align-items-center gap-3">
                        <div class="profile-circle" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                            <img src="assets/img/profil.jpeg" alt="Profil" class="w-100 h-100">
                        </div>
                        <div class="text-light fw-bolder text-center mb-1">
                            <?php echo htmlspecialchars($username); ?>
                        </div>

                        <ul class="dropdown-menu dropdown-menu-center bg-dark">
                            <li><a class="dropdown-item text-light" href="#"><i class="bi bi-person-circle"></i>
                                    Profil
                                    Saya</a></li>
                            <li><a class="dropdown-item text-light" href="#"><i class="bi bi-gear"></i>
                                    Pengaturan</a>
                            </li>
                            <?php if ($username == 'Guest'): ?>
                            <li><a class="dropdown-item text-light" href="index.php?x=login"><i
                                        class="bi bi-box-arrow-in-left"></i> Login</a></li>
                            <?php else: ?>
                    ...
                    <div class="modal-body">
                        <form action="proses/tambah_kegiatan.php" method="POST" enctype="multipart/form-data">
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-floating text-dark mb-3">
                                        <input type="text" class="form-control" name="nm_kegiatan"
                                            id="floatingNamaKegiatan" placeholder="" required>
                                        <label for="floatingNamaKegiatan">Nama Kegiatan</label>
                                    </div>

                                    <!-- Nama Pengurus -->
                                    <div class="form-floating text-dark mb-3">
                                        <input type="text" class="form-control" name="nm_pengurus"
                                            id="floatingNamaPengurus" placeholder="" required>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-floating-custom mb-3">
                                        <input type="url" class="form-control" name="youtube_url"
                                            id="floatingYoutubeUrl" placeholder="">
                                    ...
                                    <div class="form-floating-custom mb-3">
                                        <input type="url" class="form-control" name="tiktok_url" id="floatingTiktokUrl"
                                            placeholder="">
                                        <label for="floatingTiktokUrl"><i class="bi bi-tiktok text-dark"></i>
                                            TikTok</label>
                                    </div>
                                    <div class="form-floating-custom mb-3">
                                        <input type="url" class="form-control" name="facebook_url"
                                            id="floatingFacebookUrl" placeholder="">
                            ...
                            <div class="modal-footer">
                                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                                <button type="submit" class="btn btn-primary"
                                    name="input_kegiatan_validate">Upload</button>
                            </div>
                        </form>
